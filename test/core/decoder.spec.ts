...
describe('decoder', () => {
  ...
  it('repeatX', () => {
    ...
    expect(decodeText(p)('1abc').getUnsafeFailures()).toBeDefined()
    ...
    expect(decodeText(t)('1abc').getUnsafeFailures()).toBeDefined()
    ...
    expect(decodeText(m)('abc').getUnsafeFailures()).toBeDefined()
    ...
    expect(decodeText(m2)('abc').getUnsafeFailures()).toBeDefined()
    expect(decodeText(m2)('1b').getUnsafeFailures()).toBeDefined()
  ...
  it('separatedByAtLeastOnce', () => {
    ...
    expect(decodeText(p)('a').getUnsafeFailures()).toBeDefined()
    expect(decodeText(p)('a,b').getUnsafeSuccess()).toEqual(['a', 'b'])
    expect(decodeText(p)('a,b,c').getUnsafeSuccess()).toEqual(['a', 'b', 'c'])
  })
