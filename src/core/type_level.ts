 ...
 */
export type MarkOptionalFields<T, U extends any[]> =
  // `symbol` feels like a dirty trick
  U extends symbol[] ? T : ({ [K in Exclude<keyof T, TupleToUnion<U>>]: T[K] } & { [K in TupleToUnion<U>]+?: T[K] })
