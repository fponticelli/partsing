...
exports.parseText = function (parser) { return function (input) {
    return parser.run({ input: input, index: 0 })
        .match({
        success: function (r) { return result_1.ParseResult.success(input, r.value); },
        failure: function (f) { return result_1.ParseResult.failure(input, exports.failureToString(f)); }
    });
}; };
