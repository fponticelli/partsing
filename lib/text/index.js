...
exports.decodeText = function (decoder) { return function (input) {
    return decoder.run({ input: input, index: 0 })
        .match({
        success: function (r) { return result_1.DecodeResult.success(input, r.value); },
...
exports.regexp = function (pattern, group) {
    ...
    if (pattern.sticky) {
        return make(function (input) {
            ...
            if (res == null) {
                return new result_1.DecodeFailure(input, error_1.DecodeError.patternMismatch(pattern.source));
            }
            else {
                return new result_1.DecodeSuccess(__assign({}, input, { index: pattern.lastIndex }), res[group]);
            }
        });
    }
        ...
        return make(function (input) {
            ...
            if (res == null) {
                ...
                return new result_1.DecodeSuccess(__assign({}, input, { index: index }), res[group]);
            }
        });
    }
    else {
...
exports.withPosition = make(function (input) { return new result_1.DecodeSuccess(input, input.index); });
exports.rest = make(function (input) {
    var value = input.input.substring(input.index);
    return new result_1.DecodeSuccess(__assign({}, input, { index: input.input.length }), value);
});
exports.eoi = make(function (input) {
    var index = input.input.length;
    if (input.index === index) {
        return new result_1.DecodeSuccess(__assign({}, input, { index: index }), undefined);
    }
    else {
        return new result_1.DecodeFailure(input, error_1.DecodeError.expectedEot);
    }
});
exports.match = function (s) {
    ...
    return make(function (input) {
        ...
        if (value === s) {
            return new result_1.DecodeSuccess(__assign({}, input, { index: index }), s);
        }
        else {
            return new result_1.DecodeFailure(input, error_1.DecodeError.expectedMatch("\"" + s + "\""));
        }
    });
};
exports.matchInsensitive = function (s) {
    ...
    return make(function (input) {
        ...
        if (valueInsensitive === t) {
            return new result_1.DecodeSuccess(__assign({}, input, { index: index }), value);
        }
        else {
            return new result_1.DecodeFailure(input, error_1.DecodeError.expectedMatch("\"" + s + "\" (insensitive)"));
        }
    });
};
var _a = (function () {
...
exports.upperCaseLetter = exports.regexp(upperCaseLetterPattern)
    .withFailure(error_1.DecodeError.expectedOnce(error_1.Entity.UPPERCASE_LETTER));
...
exports.lowerCaseLetter = exports.regexp(lowerCaseLetterPattern)
    .withFailure(error_1.DecodeError.expectedOnce(error_1.Entity.LOWER_CASE_LETTER));
...
exports.whitespace = exports.regexp(whitespacePattern)
    .withFailure(error_1.DecodeError.expectedAtLeast(1, error_1.Entity.WHITESPACE));
...
exports.char = make(function (input) {
    if (input.index < input.input.length) {
        ...
        return new result_1.DecodeSuccess(__assign({}, input, { index: input.index + 1 }), c);
    }
    else {
        // no more characters
        return new result_1.DecodeFailure(input, error_1.DecodeError.expectedOnce(error_1.Entity.CHARACTER));
    }
});
exports.testChar = function (f) {
    return make(function (input) {
        if (input.index >= input.input.length) {
            return new result_1.DecodeFailure(input, error_1.DecodeError.unexpectedEoi);
        }
        else {
            var char_1 = input.input.charAt(input.index);
            if (f(char_1)) {
                return new result_1.DecodeSuccess(__assign({}, input, { index: input.index + 1 }), char_1);
            }
            else {
                return new result_1.DecodeFailure(input, error_1.DecodeError.expectedOnce(error_1.Entity.PREDICATE));
            }
        }
    });
};
...
exports.takeCharWhile = function (f, atLeast) {
    ...
    return make(function (input) {
        ...
        if (index - input.index < atLeast) {
            return new result_1.DecodeFailure(input, error_1.DecodeError.expectedAtLeast(atLeast, error_1.Entity.PREDICATE));
        }
        else {
            return new result_1.DecodeSuccess(__assign({}, input, { index: index }), input.input.substring(input.index, index));
        }
    });
};
exports.takeCharBetween = function (f, min, max) {
    return make(function (input) {
        ...
        if (counter < min) {
            return new result_1.DecodeFailure(input, error_1.DecodeError.expectedAtLeast(min, error_1.Entity.PREDICATE));
        }
        else {
            return new result_1.DecodeSuccess(__assign({}, input, { index: index }), input.input.substring(input.index, index));
        }
