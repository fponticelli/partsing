...
var Parser = /** @class */ (function () {
    ...
    Parser.ofGuaranteed = function (run) {
        return new Parser(function (input) {
            return parse_result_1.ParseResult.success.apply(parse_result_1.ParseResult, run(input));
        });
    };
    Parser.prototype.flatMap = function (fun) {
        ...
        return new Parser(function (input) {
            ...
            if (result.isSuccess()) {
                ...
                return new parse_result_1.ParseFailure(input, result.failure);
            }
        });
    };
    Parser.prototype.map = function (fun) {
        return this.flatMap(function (r) { return new Parser(function (input) {
            return new parse_result_1.ParseSuccess(input, fun(r));
        }); });
    };
    Parser.prototype.flatMapError = function (fun) {
        ...
        return new Parser(function (input) {
            return _this.run(input).match({
                ...
                success: function (s) { return new parse_result_1.ParseSuccess(s.input, s.value); }
            });
        });
    };
    Parser.prototype.mapError = function (fun) {
        ...
        return new Parser(function (input) {
            return _this.run(input).match({
                failure: function (f) { return new parse_result_1.ParseFailure(f.input, fun(f.failure)); },
                success: function (s) { return new parse_result_1.ParseSuccess(s.input, s.value); }
            });
        });
    };
    ...
    Parser.prototype.or = function () {
        ...
        return this.flatMapError(function (f) {
            return new Parser(function (input) {
                ...
                return new parse_result_1.ParseFailure(input, f);
            });
        });
    };
        ...
        return new Parser(function (input) {
            ...
            while (true) {
                ...
                if (result.isSuccess()) {
                    ...
                    return new parse_result_1.ParseSuccess(input, buff);
                }
            }
        });
    };
    Parser.prototype.repeatBetween = function (min, max) {
        ...
        return new Parser(function (input) {
            ...
            if (buff.length < min) {
                return new parse_result_1.ParseFailure(input, failure);
            }
            return new parse_result_1.ParseSuccess(input, buff);
        });
    };
    ...
    Parser.prototype.test = function (predicate, failure) {
        return this.flatMap(function (res) { return new Parser(function (input) {
            if (predicate(res)) {
                return parse_result_1.ParseResult.success(input, res);
            }
            else {
                return parse_result_1.ParseResult.failure(input, failure);
            }
        }); });
    };
...
exports.succeed = function (r) {
    return new Parser(function (input) { return new parse_result_1.ParseSuccess(input, r); });
};
exports.fail = function (f) {
    return new Parser(function (input) { return new parse_result_1.ParseFailure(input, f); });
};
