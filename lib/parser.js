...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.test = function (predicate, failure) {
        return this.flatMap(function (res) { return new Parser(function (source) {
            if (predicate(res)) {
                return parse_result_1.ParseResult.success(source, res);
            }
            else {
                return parse_result_1.ParseResult.failure(source, failure);
            }
        }); });
    };
