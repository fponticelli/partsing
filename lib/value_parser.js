...
exports.testValue = function (f, expected) { return make(function (input) {
    return f(input.input) ?
        parse_result_1.ParseResult.success(input, input.input) :
        parse_result_1.ParseResult.failure(input, "expected " + expected + " but got " + input.input);
}); };
exports.testType = function (expected) { return make(function (input) {
    return typeof input.input === expected ?
        parse_result_1.ParseResult.success(input, input.input) :
        parse_result_1.ParseResult.failure(input, "expected " + expected + " but got " + typeof input.input);
}); };
...
exports.anyValue = make(function (input) { return parse_result_1.ParseResult.success(input, input.input); });
        ...
        return make(function (input) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                if (r.isSuccess()) {
                    ...
                    return parse_result_1.ParseResult.failure(r.input, r.failure);
                }
            }
            return parse_result_1.ParseResult.success(input, buff);
        });
    });
};
            ...
            for (var _i = 0, mandatoryFields_1 = mandatoryFields; _i < mandatoryFields_1.length; _i++) {
                ...
                if (o.hasOwnProperty(field)) {
                    ...
                    if (result.isSuccess()) {
                        ...
                        return parse_result_1.ParseResult.failure(result.input, result.failure);
                    }
                }
                else {
                    return parse_result_1.ParseResult.failure(input, "object doesn't have mandatory field \"" + field + "\"");
                }
            }
