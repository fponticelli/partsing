...
var combine_errors_1 = require("./combine_errors");
...
exports.DecodeError = {
    ...
    combine: function (errors) { return new combine_errors_1.CombineErrors(errors); },
...
var combine_errors_2 = require("./combine_errors");
exports.CombineErrors = combine_errors_2.CombineErrors;
