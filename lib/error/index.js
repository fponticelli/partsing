...
var combine_error_1 = require("./combine_error");
...
exports.DecodeError = {
    ...
    combine: function (errors) { return new combine_error_1.CombineError(errors); },
...
var combine_error_2 = require("./combine_error");
exports.CombineError = combine_error_2.CombineError;
