...
exports.letter = function () {
    return exports.regexp(letterPattern).withFailure('one letter');
};
...
exports.upperCaseLetter = function () {
    return exports.regexp(upperCaseLetterPattern).withFailure('one letter');
};
...
exports.lowerCaseLetter = function () {
    return exports.regexp(lowerCaseLetterPattern).withFailure('one letter');
};
...
exports.digit = function () {
    return exports.regexp(digitPattern).withFailure('one digit');
};
...
exports.whitespace = function () {
    return exports.regexp(whitespacePattern).withFailure('whitespace');
};
exports.optionalWhitespace = function () {
    return exports.regexp(optionalWhitespacePattern).withFailure('optional whitespace');
};
